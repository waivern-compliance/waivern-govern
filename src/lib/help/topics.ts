...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    path: "/app/breaches",
    keywords: [
      "breach", "incident", "72 hours", "seventy-two", "article 33", "article 34",
      "notify", "ico", "supervisory authority", "data subjects", "ransomware", "leak",
    ],
    sections: [
      {
      ...
      {
        heading: "Decisions, including the ones nobody required",
        body: [
    ...
    related: ["risks", "service-levels", "audit", "ropa"],
  },
  {
    id: "ai-register",
...
export const HELP_GROUPS: Array<{ heading: string; ids: string[] }> = [
  ...
  },
  {
    ...
    ids: ["ropa", "third-parties", "breaches", "ai-register", "ai-chain", "transfers", "findings"],
  },
  {
